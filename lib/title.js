...
create = function () {
 let phaserImg=this.add.image(800, 450, "phaser");
  
 this.renderer.pipelines.add("myShader", new myShader(this.game));
 phaserImg.setPipeline("myShader");
