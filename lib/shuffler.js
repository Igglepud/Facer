let shufflerScene = new Phaser.Scene("Shuffler");

shufflerScene.init = function () {
    ...
    for (i = 0; i < this.numFaces; i++) {
      ...
      if (this.startNumber == 3) {
                      ...
                      this.tweenTimer = this.time.addEvent({
                        ...
                        callback: function () {
                          ...
                          if (this.id1 == this.id2) {
                            ...
                            this.matches++;
                            this.matching = true;
                            for (i = 0; i < this.winEmitters.length; i++) {
        ...
        for (j = 0; j < parts.length; j++) {
          part = Phaser.Utils.Objects.Clone(parts[j]);
          this.clone.add(part);
        }
...
shufflerScene.preload = function () {};
// create after preload
shufflerScene.create = function () {
  //create match text
    ...
    .on(
      ...
      function () {
        ...
        for (i = 0; i < parts.length; i++) {
          part = Phaser.Utils.Objects.Clone(parts[i]);
